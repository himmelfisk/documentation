(() => {
  ...
  var init_en = __esm({
    "src/locales/en.json"() {
      en_default = {
        ...
        "login.title": "Sign In",
        "login.prompt": "Sign in with your Microsoft account to continue.",
        "login.button": "\u{1F510} Sign in with Microsoft",
  ...
  var init_no = __esm({
    "src/locales/no.json"() {
      no_default = {
        ...
        "login.prompt": "Logg inn med Microsoft-kontoen din for \xE5 fortsette.",
        "login.button": "\u{1F510} Logg inn med Microsoft",
        "login.error": "Innlogging feilet. Pr\xF8v igjen.",
  ...
  var isNative, msalConfig, loginRequest, msalInstance, currentAccount, AUTH_HASH_TIMEOUT_MS;
  var init_auth = __esm({
    "src/js/auth.js"() {
      init_dist2();
      init_dist();
