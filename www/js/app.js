(() => {
    ...
    "node_modules/@azure/msal-common/dist-browser/utils/StringUtils.mjs"() {
      ...
      StringUtils = class {
        ...
        static queryStringToObject(query) {
          ...
          const decode3 = (s2) => decodeURIComponent(s2.replace(/\+/g, " "));
          params.forEach((pair) => {
            if (pair.trim()) {
  ...
  var clientInfoDecodingError, clientInfoEmptyError, tokenParsingError, nullOrEmptyToken, endpointResolutionError, networkError, openIdConfigError, hashNotDeserialized, invalidState, stateMismatch, stateNotFound, nonceMismatch, authTimeNotFound, maxAgeTranspired, multipleMatchingTokens, multipleMatchingAppMetadata, requestCannotBeMade, cannotRemoveEmptyScope, cannotAppendScopeSet, emptyInputScopeSet, noAccountInSilentRequest, invalidCacheRecord, invalidCacheEnvironment, noAccountFound, noCryptoObject, unexpectedCredentialType, tokenRefreshRequired, tokenClaimsCnfRequiredForSignedJwt, authorizationCodeMissingFromServerResponse, bindingKeyNotRemoved, endSessionEndpointNotSupported, keyIdMissing, noNetworkConnectivity, userCanceled, methodNotImplemented, nestedAppAuthBridgeDisabled, platformBrokerError, resourceParameterRequired, misplacedResourceParam;
  ...
  var noTokensFound, nativeAccountUnavailable, refreshTokenExpired, uxNotAllowed, interactionRequired, consentRequired, loginRequired, badToken, interruptedUser;
  ...
  var BrowserConstants, PlatformAuthConstants, NativeExtensionMethod, BrowserCacheLocation, HTTP_REQUEST_TYPE, INTERACTION_TYPE, TemporaryCacheKeys, InMemoryCacheKeys, ApiId, ApiName, apiIdToName, InteractionType, DEFAULT_REQUEST, KEY_FORMAT_JWK, DB_NAME, DB_VERSION, DB_TABLE_NAME, CacheLookupPolicy, iFrameRenewalPolicies;
  ...
  var pkceNotCreated, earJwkEmpty, earJweEmpty, cryptoNonExistent, emptyNavigateUri, hashEmptyError, noStateInHash, hashDoesNotContainKnownProperties, unableToParseState, stateInteractionTypeMismatch, interactionInProgress, interactionInProgressCancelled, popupWindowError, emptyWindowError, userCancelled, redirectBridgeEmptyResponse, redirectInIframe, blockIframeReload, blockNestedPopups, silentLogoutUnsupported, noAccountError, noTokenRequestCacheError, unableToParseTokenRequestCacheError, nonBrowserEnvironment, databaseNotOpen, noNetworkConnectivity2, postRequestFailed2, getRequestFailed, failedToParseResponse, cryptoKeyNotFound, authCodeRequired, authCodeOrNativeAccountIdRequired, spaCodeAndNativeAccountIdPresent, databaseUnavailable, unableToAcquireTokenFromNativePlatform, nativeHandshakeTimeout, nativeExtensionNotInstalled, nativeConnectionNotEstablished, uninitializedPublicClientApplication, nativePromptNotSupported, invalidBase64String, invalidPopTokenRequest, failedToBuildHeaders, failedToParseHeaders, failedToDecryptEarResponse, timedOut, emptyResponse;
  var init_BrowserAuthErrorCodes = __esm({
    "node_modules/@azure/msal-browser/dist/error/BrowserAuthErrorCodes.mjs"() {
      ...
      redirectBridgeEmptyResponse = "redirect_bridge_empty_response";
  ...
  var storageNotSupported, inMemRedirectUnavailable;
  ...
  var activeBridgeMonitor, addClientCapabilitiesToClaims2;
  var init_BrowserUtils = __esm({
    "node_modules/@azure/msal-browser/dist/utils/BrowserUtils.mjs"() {
      ...
      activeBridgeMonitor = null;
      addClientCapabilitiesToClaims2 = RequestParameterBuilder_exports.addClientCapabilitiesToClaims;
    }
  });

  // node_modules/@azure/msal-browser/dist/telemetry/BrowserPerformanceEvents.mjs
  var AcquireTokenFromCache, AcquireTokenByRefreshToken, AcquireTokenSilentAsync, CryptoOptsGetPublicKeyThumbprint, CryptoOptsSignJwt, SilentCacheClientAcquireToken, SilentIframeClientAcquireToken, AwaitConcurrentIframe, SilentRefreshClientAcquireToken, StandardInteractionClientGetDiscoveredAuthority, NativeInteractionClientAcquireToken, RefreshTokenClientAcquireTokenByRefreshToken, AcquireTokenBySilentIframe, InitializeBaseRequest, InitializeSilentRequest, InitializeCache, SilentIframeClientTokenHelper, SilentHandlerInitiateAuthRequest, SilentHandlerMonitorIframeForHash, SilentHandlerLoadFrameSync, StandardInteractionClientCreateAuthCodeClient, StandardInteractionClientGetClientConfiguration, StandardInteractionClientInitializeAuthorizationRequest, SilentFlowClientAcquireCachedToken, GetStandardParams, HandleCodeResponse, HandleResponseEar, HandleResponsePlatformBroker, HandleResponseCode, AuthClientAcquireToken, DeserializeResponse, AuthorityFactoryCreateDiscoveredInstance, AcquireTokenByCodeAsync, HandleRedirectPromiseMeasurement, HandleNativeRedirectPromiseMeasurement, NativeMessageHandlerHandshake, ImportExistingCache, GeneratePkceCodes, GenerateCodeVerifier, GenerateCodeChallengeFromVerifier, Sha256Digest, GetRandomValues, GenerateHKDF, GenerateBaseKey, Base64Decode, UrlEncodeArr, Encrypt, Decrypt, GenerateEarKey, DecryptEarResponse;
  var init_BrowserPerformanceEvents = __esm({
    "node_modules/@azure/msal-browser/dist/telemetry/BrowserPerformanceEvents.mjs"() {
      "use strict";
  ...
  var AcquireTokenSilent, AcquireTokenByCode, AcquireTokenPopup, AcquireTokenPreRedirect, AcquireTokenRedirect, SsoSilent, InitializeClientApplication, LocalStorageUpdated;
  var init_BrowserRootPerformanceEvents = __esm({
    "node_modules/@azure/msal-browser/dist/telemetry/BrowserRootPerformanceEvents.mjs"() {
      "use strict";
  ...
  var PREFIX, BROWSER_PREFIX, CACHE_KEY_SEPARATOR2, CREDENTIAL_SCHEMA_VERSION, ACCOUNT_SCHEMA_VERSION, LOG_LEVEL_CACHE_KEY, LOG_PII_CACHE_KEY, BROWSER_PERF_ENABLED_KEY, PLATFORM_AUTH_DOM_SUPPORT, VERSION_CACHE_KEY, ACCOUNT_KEYS, TOKEN_KEYS;
  var init_CacheKeys = __esm({
    "node_modules/@azure/msal-browser/dist/cache/CacheKeys.mjs"() {
      "use strict";
      PREFIX = "msal";
      BROWSER_PREFIX = "browser";
      CACHE_KEY_SEPARATOR2 = "|";
      CREDENTIAL_SCHEMA_VERSION = 2;
      ACCOUNT_SCHEMA_VERSION = 2;
      LOG_LEVEL_CACHE_KEY = `${PREFIX}.${BROWSER_PREFIX}.log.level`;
      LOG_PII_CACHE_KEY = `${PREFIX}.${BROWSER_PREFIX}.log.pii`;
      BROWSER_PERF_ENABLED_KEY = `${PREFIX}.${BROWSER_PREFIX}.performance.enabled`;
      PLATFORM_AUTH_DOM_SUPPORT = `${PREFIX}.${BROWSER_PREFIX}.platform.auth.dom`;
      VERSION_CACHE_KEY = `${PREFIX}.version`;
  ...
  var init_LocalStorage = __esm({
    "node_modules/@azure/msal-browser/dist/cache/LocalStorage.mjs"() {
      ...
      init_index_browser();
      init_BrowserPerformanceEvents();
      init_BrowserRootPerformanceEvents();
      init_BrowserCrypto();
      init_Base64Decode();
      init_Base64Encode();
      init_BrowserAuthError();
  ...
  var init_BrowserCacheManager = __esm({
    "node_modules/@azure/msal-browser/dist/cache/BrowserCacheManager.mjs"() {
      ...
      DEFAULT_BROWSER_CACHE_MANAGER = (clientId, logger, performanceClient, eventHandler) => {
        const cacheOptions = {
  ...
  var contentError, pageException, userSwitch;
  ...
  var INVALID_METHOD_ERROR, NativeAuthError;
  ...
  var clientDataAccountTypeMapping;
  var init_Authorize2 = __esm({
    "node_modules/@azure/msal-browser/dist/protocol/Authorize.mjs"() {
      ...
      init_BrowserCrypto();
      init_BrowserAuthErrorCodes();
      clientDataAccountTypeMapping = /* @__PURE__ */ new Map([
        ["e", "AAD"],
        ["m", "MSA"]
      ]);
    }
  ...
  var AuthenticationScheme2, ResponseMode2, PromptValue2, JsonWebTokenTypes2, OIDC_DEFAULT_SCOPES2;
  var init_dist2 = __esm({
    "node_modules/@azure/msal-browser/dist/index.mjs"() {
      "use strict";
      init_index_browser();
      init_PublicClientApplication();
      AuthenticationScheme2 = Constants_exports.AuthenticationScheme;
      ResponseMode2 = Constants_exports.ResponseMode;
      PromptValue2 = Constants_exports.PromptValue;
      JsonWebTokenTypes2 = Constants_exports.JsonWebTokenTypes;
      OIDC_DEFAULT_SCOPES2 = Constants_exports.OIDC_DEFAULT_SCOPES;
    }
  });
    ...
    "src/js/auth.js"() {
      ...
      msalConfig = {
        auth: {
          ...
          postLogoutRedirectUri: getRedirectUri2(),
  ...
  function parseItemLocationBox(dataView, version3, contentOffset, boxLength) {
    const FLAGS_SIZE = 3;
    const { offsets, sizes } = getItemLocationBoxOffsetsAndSizes(version3, contentOffset + FLAGS_SIZE);
    ...
    const indexSize = getIndexSize(dataView, offsets.indexSize, version3);
    sizes.item.extent.extentIndex = indexSize !== void 0 ? indexSize : 0;
    const itemCount = getItemCount(dataView, offsets.itemCount, version3);
    return {
      type: "iloc",
      items: getItems(dataView, version3, offsets, sizes, offsetSize, lengthSize, indexSize, itemCount),
      length: boxLength
    };
  }
  function getItemLocationBoxOffsetsAndSizes(version3, contentOffset) {
    const sizes = {
      item: {
  ...
  function getIndexSize(dataView, offset, version3) {
    if (version3 === 1 || version3 === 2) {
      return dataView.getUint8(offset) & 15;
    }
    return void 0;
  }
  function getItemCount(dataView, offset, version3) {
    if (version3 < 2) {
  ...
  function getItems(dataView, version3, offsets, sizes, offsetSize, lengthSize, indexSize, itemCount) {
    if (itemCount === void 0) {
      return [];
    }
    const items = [];
    ...
    for (let i = 0; i < itemCount; i++) {
      const item = { extents: [] };
      item.itemId = getItemId(dataView, offset, version3);
      offset += sizes.item.itemId;
      item.constructionMethod = version3 === 1 || version3 === 2 ? dataView.getUint16(offset) & 15 : void 0;
      ...
      for (let j = 0; j < item.extentCount; j++) {
        const extent = {};
        extent.extentIndex = getExtentIndex(dataView, version3, offset, indexSize);
  ...
  function getItemId(dataView, offset, version3) {
    if (version3 < 2) {
      return dataView.getUint16(offset);
    } else if (version3 === 2) {
      return dataView.getUint32(offset);
  ...
  function getExtentIndex(dataView, version3, offset, indexSize) {
    if ((version3 === 1 || version3 === 2) && indexSize > 0) {
  ...
  function parseBox(dataView, offset) {
    ...
    const version3 = dataView.getUint8(contentOffset);
    if (type === TYPE_META) {
      return parseMetadataBox(dataView, offset, contentOffset + VERSION_SIZE, length);
    }
    if (type === TYPE_ILOC) {
      return parseItemLocationBox(dataView, version3, contentOffset + VERSION_SIZE, length);
    }
    if (type === TYPE_IINF) {
      return parseItemInformationBox(dataView, offset, version3, contentOffset + VERSION_SIZE, length);
    }
    if (type === TYPE_INFE) {
      return parseItemInformationEntryBox(dataView, offset, version3, contentOffset + VERSION_SIZE, length);
    }
    return {
  ...
  function parseItemInformationBox(dataView, startOffset, version3, contentOffset, length) {
    const { offsets } = getItemInformationBoxOffsetsAndSizes(version3, contentOffset);
    return {
      type: "iinf",
  ...
  function getItemInformationBoxOffsetsAndSizes(version3, contentOffset) {
    const FLAGS_SIZE = 3;
  ...
  function parseItemInformationEntryBox(dataView, startOffset, version3, contentOffset, length) {
    const FLAGS_SIZE = 3;
  ...
  function parseNodeAttributesAsTags(attributes) {
    ...
    for (const name3 in attributes) {
      try {
        if (isTagAttribute(name3)) {
          tags[getLocalName(name3)] = {
            value: attributes[name3],
            attributes: {},
            description: getDescription(attributes[name3], name3)
          };
        }
      } catch (error) {
      }
  ...
  function isTagAttribute(name3) {
    return name3 !== "rdf:parseType" && !isNamespaceDefinition(name3);
  }
  function isNamespaceDefinition(name3) {
    return name3.split(":")[0] === "xmlns";
  }
  function getLocalName(name3) {
    if (/^MicrosoftPhoto(_\d+_)?:Rating$/i.test(name3)) {
      return "RatingPercent";
    }
    return name3.split(":")[1];
  }
  function getDescription(value, name3 = void 0) {
    if (Array.isArray(value)) {
      const arrayDescription = getDescriptionOfArray(value);
      if (name3 && typeof xmp_tag_names_default[name3] === "function") {
        return xmp_tag_names_default[name3](value, arrayDescription);
      }
    ...
    try {
      if (name3 && typeof xmp_tag_names_default[name3] === "function") {
        return xmp_tag_names_default[name3](value);
      }
  ...
  function parseNodeChildrenAsTags(children) {
    const tags = {};
    for (const name3 in children) {
      try {
        if (!isNamespaceDefinition(name3)) {
          tags[getLocalName(name3)] = parseNodeAsTag(children[name3], name3);
        }
      } catch (error) {
      }
    }
  ...
  function parseNodeAsTag(node, name3) {
    if (isDuplicateTag(node)) {
      return parseNodeAsDuplicateTag(node, name3);
    }
    if (isEmptyResourceTag(node)) {
      return { value: "", attributes: {}, description: "" };
    }
    if (hasNestedSimpleRdfDescription(node)) {
      return parseNodeAsSimpleRdfDescription(node, name3);
    }
    if (hasNestedStructureRdfDescription(node)) {
      return parseNodeAsStructureRdfDescription(node, name3);
    }
    if (isCompactStructure(node)) {
      return parseNodeAsCompactStructure(node, name3);
    }
    if (isArray(node)) {
      return parseNodeAsArray(node, name3);
    }
    return parseNodeAsSimpleValue(node, name3);
  }
  ...
  function parseNodeAsDuplicateTag(node, name3) {
    return parseNodeAsSimpleValue(node[node.length - 1], name3);
  }
  ...
  function parseNodeAsSimpleRdfDescription(node, name3) {
    ...
    return {
      value,
      attributes,
      description: getDescription(value, name3)
    };
  }
  function parseNodeAttributes(node) {
    const attributes = {};
    for (const name3 in node.attributes) {
      if (name3 !== "rdf:parseType" && name3 !== "rdf:resource" && !isNamespaceDefinition(name3)) {
        attributes[getLocalName(name3)] = node.attributes[name3];
      }
    }
    return attributes;
  }
  function parseNodeChildrenAsAttributes(node) {
    const attributes = {};
    for (const name3 in node.value) {
      if (name3 !== "rdf:value" && !isNamespaceDefinition(name3)) {
        attributes[getLocalName(name3)] = node.value[name3].value;
      }
    }
    return attributes;
  }
  ...
  function parseNodeAsStructureRdfDescription(node, name3) {
    const tag = {
      value: {},
      attributes: {}
    };
  ...
  function parseNodeAsArray(node, name3) {
  ...
  function parseNodeAsSimpleValue(node, name3) {
  ...
  function getFixedPointNumber(dataView, offset, binaryPoint) {
    ...
    const sign2 = number >>> 31 === 0 ? 1 : -1;
    const integer = (number & 2130706432) >>> 32 - binaryPoint;
    const fraction2 = number & parseInt(strRepeat("1", 32 - binaryPoint), 2);
    return sign2 * parseFloatRadix(integer.toString(2) + "." + padStart(fraction2.toString(2), 32 - binaryPoint, "0"), 2);
  }
  ...
  function read12(dataView, pngTextChunks, async, includeUnknown, computed = false, tagFilter = NOOP_TAG_FILTER) {
    ...
    for (let i = 0; i < pngTextChunks.length; i++) {
      ...
      if (nameAndValue instanceof Promise) {
        tagsPromises.push(nameAndValue.then(({ name: name3, value, description }) => {
          try {
            if (constants_default.USE_EXIF && isExifGroupTag(name3, value)) {
            ...
            } else if (constants_default.USE_IPTC && isIptcGroupTag(name3, value)) {
            ...
            } else if (name3 && !isExifGroupTag(name3, value) && !isIptcGroupTag(name3, value)) {
        ...
        const { name: name3, value, description } = nameAndValue;
        if (name3 && tagFilter.shouldParseGroup("png")) {
          tags[name3] = {
            value,
            description
          };
  ...
  function getName(type, langChars, keywordChars) {
    const name3 = getStringValueFromArray(keywordChars);
  ...
  function isExifGroupTag(name3, value) {
    return name3.toLowerCase() === "raw profile type exif" && value.substring(1, 5) === "exif";
  }
  function isIptcGroupTag(name3, value) {
    return name3.toLowerCase() === "raw profile type iptc" && value.substring(1, 5) === "iptc";
  }
